...
const Profile = () => {
  ...
  const handleEdit = () => { console.log("Poop") };
      ...
      <ScrollView
        ...
        <View className='flex-row justify-center flex mt-5'>
          <View className='flex flex-col items-center relative mt-5'>
            ...
            <Text className='text-3xl font-rubik-bold mt-2'>
              {user?.name}
            </Text>
          </View>
        </View>
        <View className="flex flex-col mt-10">
          ...
          <SettingsItem icon={icons.shield} title="Blocked List" />
        </View>

        <View className='flex felx-col mt-5 border-t pt-5 border-primary-200'>
